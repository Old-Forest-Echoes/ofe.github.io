...
(() => {
    ...
    "packages/shared/render/plugins/BaseSiteModules/tram-min.js"() {
      ...
      window.tram = function (a) {
        ...
        var l = function (a2, b2, c2) {
          ...
          }, o = document, p = window, q = "bkwld-tram", r = /[\-\.0-9]/g, s = /[A-Z]/, t = "number", u = /^(rgb|#)/,
          v = /(em|cm|mm|in|pt|pc|px)$/, w = /(em|cm|mm|in|pt|pc|px|%)$/, x = /(deg|rad|turn)$/, y = "unitless",
          z = /(all|none) 0s ease 0s/, A = /^(width|height)$/, B = " ", C = o.createElement("a"), D = [
            "Webkit",
            "Moz",
            "O",
            "ms"
  ...
  var require_underscore_custom = __commonJS({
    "packages/shared/render/plugins/BaseSiteModules/underscore-custom.js"(exports, module2) {
      "use strict";
      var $2 = window.$;
      ...
      module2.exports = function () {
        ...
        var push = ArrayProto.push, slice3 = ArrayProto.slice, concat2 = ArrayProto.concat,
          toString3 = ObjProto.toString, hasOwnProperty9 = ObjProto.hasOwnProperty;
        ...
        var any = _.some = _.any = function (obj, predicate, context) {
          ...
          each(obj, function (value, index, list) {
            if (result2 || (result2 = predicate.call(context, value, index, list)))
              return breaker;
          });
          return !!result2;
        };
  ...
  var require_webflow_lib = __commonJS({
    "packages/shared/render/plugins/BaseSiteModules/webflow-lib.js"(exports, module2) {
      "use strict";
      var Webflow = {};
      var modules = {};
      var primary = [];
  ...
  var require_webflow_focus_visible = __commonJS({
    "packages/shared/render/plugins/BaseSiteModules/webflow-focus-visible.js"(exports, module2) {
      "use strict";
  ...
  var require_webflow_focus = __commonJS({
    "packages/shared/render/plugins/BaseSiteModules/webflow-focus.js"(exports, module2) {
      "use strict";
      var Webflow = require_webflow_lib();
  ...
  var require_webflow_ix_events = __commonJS({
    "packages/shared/render/plugins/BaseSiteModules/webflow-ix-events.js"(exports, module2) {
      "use strict";
      var $2 = window.jQuery;
      var api = {};
      var eventQueue = [];
  ...
  var require_webflow_ix2_events = __commonJS({
    "packages/shared/render/plugins/BaseSiteModules/webflow-ix2-events.js"(exports, module2) {
      "use strict";
  ...
  var TRANSFORM_MOVE, TRANSFORM_SCALE, TRANSFORM_ROTATE, TRANSFORM_SKEW, STYLE_SIZE, STYLE_FILTER, STYLE_FONT_VARIATION,
    ReducedMotionTypes;
  ...
  var IX2_RAW_DATA_IMPORTED, IX2_SESSION_INITIALIZED, IX2_SESSION_STARTED, IX2_SESSION_STOPPED, IX2_PREVIEW_REQUESTED,
    IX2_PLAYBACK_REQUESTED, IX2_STOP_REQUESTED, IX2_CLEAR_REQUESTED, IX2_EVENT_LISTENER_ADDED, IX2_EVENT_STATE_CHANGED,
    IX2_ANIMATION_FRAME_CHANGED, IX2_PARAMETER_CHANGED, IX2_INSTANCE_ADDED, IX2_INSTANCE_STARTED, IX2_INSTANCE_REMOVED,
    IX2_ELEMENT_STATE_CHANGED, IX2_ACTION_LIST_PLAYBACK_CHANGED, IX2_VIEWPORT_WIDTH_CHANGED, IX2_MEDIA_QUERIES_DEFINED,
  ...
  var IX2_ID_DELIMITER, WF_PAGE, W_MOD_JS, W_MOD_IX, BOUNDARY_SELECTOR, CONFIG_X_VALUE, CONFIG_Y_VALUE, CONFIG_Z_VALUE,
    CONFIG_VALUE, CONFIG_X_UNIT, CONFIG_Y_UNIT, CONFIG_Z_UNIT, CONFIG_UNIT, TRANSFORM, TRANSLATE_X, TRANSLATE_Y,
    TRANSLATE_Z, TRANSLATE_3D, SCALE_X, SCALE_Y, SCALE_Z, SCALE_3D, ROTATE_X, ROTATE_Y, ROTATE_Z, SKEW, SKEW_X, SKEW_Y,
    OPACITY, FILTER, FONT_VARIATION_SETTINGS, WIDTH, HEIGHT, BACKGROUND_COLOR, BACKGROUND, BORDER_COLOR, COLOR, DISPLAY,
    FLEX, WILL_CHANGE, AUTO, COMMA_DELIMITER, COLON_DELIMITER, BAR_DELIMITER, CHILDREN, IMMEDIATE_CHILDREN, SIBLINGS,
    PARENT, PRESERVE_3D, HTML_ELEMENT, PLAIN_OBJECT, ABSTRACT_NODE, RENDER_TRANSFORM, RENDER_GENERAL, RENDER_STYLE,
    RENDER_PLUGIN;
  ...
  var require_arrayLikeKeys = __commonJS({
    "node_modules/lodash/_arrayLikeKeys.js"(exports, module2) {
      ...
      function arrayLikeKeys(value, inherited) {
        var isArr = isArray2(value), isArg = !isArr && isArguments(value), isBuff = !isArr && !isArg && isBuffer(value),
          isType = !isArr && !isArg && !isBuff && isTypedArray(value), skipIndexes = isArr || isArg || isBuff || isType,
          result2 = skipIndexes ? baseTimes(value.length, String) : [], length = result2.length;
    ...
    "node_modules/lodash/_getTag.js"(exports, module2) {
      ...
      if (DataView && getTag(new DataView(new ArrayBuffer(1))) != dataViewTag || Map2 && getTag(new Map2()) != mapTag || Promise3 && getTag(Promise3.resolve()) != promiseTag || Set2 && getTag(new Set2()) != setTag || WeakMap2 && getTag(new WeakMap2()) != weakMapTag) {
        getTag = function (value) {
          var result2 = baseGetTag(value), Ctor = result2 == objectTag ? value.constructor : void 0,
  ...
  var require_baseIsEqualDeep = __commonJS({
    "node_modules/lodash/_baseIsEqualDeep.js"(exports, module2) {
      ...
      function baseIsEqualDeep(object, other, bitmask, customizer, equalFunc, stack) {
        var objIsArr = isArray2(object), othIsArr = isArray2(other), objTag = objIsArr ? arrayTag : getTag(object),
    ...
    "packages/systems/ix2/plugins/IX2Spline.js"(exports) {
      ...
      var getPluginOrigin2 = (refState2, actionItem) => {
        ...
        if (refState2) {
          ...
          if (diffKeys.length) {
            const origin2 = diffKeys.reduce((result2, key) => {
              result2[key] = DEFAULT_VALUES[key];
              return result2;
            }, refState2);
            return origin2;
          }
        ...
        const origin = destinationKeys.reduce((result2, key) => {
          result2[key] = DEFAULT_VALUES[key];
          return result2;
        }, {});
        return origin;
  ...
  var require_defaultTo = __commonJS({
    "node_modules/lodash/defaultTo.js"(exports, module2) {
  ...
  var require_findLastIndex = __commonJS({
    "node_modules/lodash/findLastIndex.js"(exports, module2) {
      var baseFindIndex = require_baseFindIndex();
      var baseIteratee = require_baseIteratee();
      var toInteger = require_toInteger();
      var nativeMax = Math.max;
  ...
  var require_findLast = __commonJS({
    "node_modules/lodash/findLast.js"(exports, module2) {
      var createFind = require_createFind();
  ...
  function renderFilter(element, actionState, actionItemConfig, elementApi) {
    const filterValue = (0, import_reduce.default)(
      actionState,
      (result2, value, type) => `${result2} ${type}(${value}${getFilterUnit(type, actionItemConfig)})`,
      ""
    );
    const {setStyle: setStyle2} = elementApi;
  ...
  var import_defaultTo, import_reduce, import_findLast, import_timm4, import_normalizeColor, BACKGROUND2, TRANSFORM2,
    TRANSLATE_3D2, SCALE_3D2, ROTATE_X2, ROTATE_Y2, ROTATE_Z2, SKEW2, PRESERVE_3D2, FLEX2, OPACITY2, FILTER2,
    FONT_VARIATION_SETTINGS2, WIDTH2, HEIGHT2, BACKGROUND_COLOR2, BORDER_COLOR2, COLOR2, CHILDREN2, IMMEDIATE_CHILDREN2,
    SIBLINGS2, PARENT2, DISPLAY2, WILL_CHANGE2, AUTO2, COMMA_DELIMITER2, COLON_DELIMITER2, BAR_DELIMITER2,
    RENDER_TRANSFORM2, RENDER_GENERAL2, RENDER_STYLE2, RENDER_PLUGIN2, TRANSFORM_MOVE2, TRANSFORM_SCALE2,
    TRANSFORM_ROTATE2, TRANSFORM_SKEW2, STYLE_OPACITY, STYLE_FILTER2, STYLE_FONT_VARIATION2, STYLE_SIZE2,
    STYLE_BACKGROUND_COLOR, STYLE_BORDER, STYLE_TEXT_COLOR, GENERAL_DISPLAY, OBJECT_VALUE, trim, colorStyleProps,
    willChangeProps, objectCache, instanceCount, elementCount, strictEqual, pxValueRegex, getFilterDefaults,
    getFontVariationDefaults, reduceFilters, reduceFontVariations, getItemConfigByKey, transformDefaults,
    filterDefaults, fontVariationDefaults, getFilterUnit, transformKeys, paramCapture, rgbValidRegex, rgbMatchRegex,
      ...
      timedInstance = (state, action) => {
        ...
        if (active && origin) {
          ...
          if (destinationKeys.length) {
            current = destinationKeys.reduce((result2, key) => {
    ...
    "node_modules/lodash/_getFuncName.js"(exports, module2) {
      ...
      function getFuncName(func) {
        var result2 = func.name + "", array = realNames[result2],
          length = hasOwnProperty9.call(realNames, result2) ? array.length : 0;
        while (length--) {
  ...
  var import_flow, import_get, import_clamp, import_shared5, MOUSE_CLICK, MOUSE_SECOND_CLICK, MOUSE_DOWN, MOUSE_UP,
    ...
    baseScrollActionGroupOptions, AUTO_STOP_DISABLED_EVENTS, getDocumentState, areBoxesIntersecting, isElementHovered,
    isElementVisible, whenComponentActiveChange, whenElementHoverChange, whenElementVisibiltyChange,
    whenScrollDirectionChange, pointIntersects, whenPageLoadFinish, whenPageLoadStart, whenClickCountChange,
    getComponentActiveOptions, getComponentInactiveOptions, scrollIntoOutOfViewOptions, MOUSE_OUT_ROUND_THRESHOLD,
  ...
  var import_find2, import_get2, import_size, import_omitBy, import_isEmpty, import_mapValues, import_forEach,
    ...
    shouldAllowMediaQuery2, cleanupHTMLElement2, clearObjectCache2, stringifyTarget2, mediaQueriesEqual2, shallowEqual2,
    isPluginType2, createPluginInstance2, getPluginDuration2, ua, IS_MOBILE_SAFARI, THROTTLED_EVENT_WAIT,
    WINDOW_RESIZE_EVENTS, mapFoundValues, forEachEventTarget, getAffectedForEvent;
  ...
  var require_webflow_ix2 = __commonJS({
    "packages/shared/render/plugins/BaseSiteModules/webflow-ix2.js"(exports, module2) {
      "use strict";
      var Webflow = require_webflow_lib();
  ...
  var require_webflow_links = __commonJS({
    "packages/shared/render/plugins/BaseSiteModules/webflow-links.js"(exports, module2) {
      "use strict";
      var Webflow = require_webflow_lib();
  ...
  var require_webflow_scroll = __commonJS({
    "packages/shared/render/plugins/BaseSiteModules/webflow-scroll.js"(exports, module2) {
      "use strict";
      var Webflow = require_webflow_lib();
  ...
  var require_webflow_touch = __commonJS({
    "packages/shared/render/plugins/BaseSiteModules/webflow-touch.js"(exports, module2) {
      "use strict";
      var Webflow = require_webflow_lib();
  ...
  var require_webflow_navbar = __commonJS({
    "packages/shared/render/plugins/Navbar/webflow-navbar.js"(exports, module2) {
      "use strict";
      var Webflow = require_webflow_lib();
      ...
      Webflow.define("navbar", module2.exports = function ($2, _) {
        ...
        var outsideDebounced = debounce2(function (data, $target) {
          if (!data.open) {
            return;
          }
...
Webflow.require('ix2').init(
  {
    "events": {
      "e": {
        ...
        "target": {
          "id": "666a9a91033326be571764f0|fd30070d-d8f3-6d7f-8115-94299df0282c",
          "appliesTo": "ELEMENT",
          "styleBlockIds": []
        },
        "targets": [{
      ...
      "e-3": {
        ...
        "mediaQueries": ["main", "medium", "small", "tiny"],
        "target": {
          "id": "666a9a91033326be571764f0|6ac5f68c-1855-9371-f652-eb52377ce288",
          "appliesTo": "ELEMENT",
          "styleBlockIds": []
        },
        "targets": [{
        ...
        "actionItemGroups": [{
          "actionItems": [{
            ...
            "config": {
              ...
              "easing": "",
              "duration": 0,
              "target": {"useEventTarget": true, "id": "666a9a91033326be571764f0|fd30070d-d8f3-6d7f-8115-94299df0282c"},
              "value": "none"
            }
          }]
        }, {
          "actionItems": [{
            ...
            "config": {
              ...
              "easing": "",
              "duration": 0,
              "target": {"id": "666a9a91033326be571764f0|aac2449a-bd62-24b4-caab-76275766a1d6"},
              "value": "block"
            }
          }]
        }, {
          "actionItems": [{
            ...
            "config": {
              ...
              "easing": "",
              "duration": 0,
              "target": {"id": "666a9a91033326be571764f0|6ac5f68c-1855-9371-f652-eb52377ce288"},
              "value": "inline"
            }
          }]
        }],
        "useFirstGroupAsInitialState": false,
        "createdOn": 1663419661752
      },
      "a-2": {
        "id": "a-2",
        "title": "New Timed Animation",
        "actionItemGroups": [{
          ...
          "actionItems": [{
            ...
            "config": {
              ...
              "easing": "",
              "duration": 0,
              "target": {"useEventTarget": true, "id": "666a9a91033326be571764f0|6ac5f68c-1855-9371-f652-eb52377ce288"},
              "value": "none"
            }
          }]
        }, {
          "actionItems": [{
            ...
            "config": {
              ...
              "easing": "",
              "duration": 0,
              "target": {"id": "666a9a91033326be571764f0|fd30070d-d8f3-6d7f-8115-94299df0282c"},
              "value": "inline"
            }
          }]
        }],
        "useFirstGroupAsInitialState": false,
        "createdOn": 1663419955854
      }
    },
    "site": {
